...
//       <header className="w-full flex items-center sticky top-0 z-50 border-b bg-white">
...
//             <Link to="/signup" className="text-sm font-medium text-slate-600 hover:text-slate-900">
//               Sign In
//             </Link>
//             <button type="button"  className="cursor text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">
//               Get Started
//             </button>
//           </div>
//         </div>
...
//                     globe. Anyone can publish on Pencraft.
//                   </p>
//                 </div>
//                 <div className="flex flex-col gap-2 min-[400px]:flex-row">
//                   <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">Start writing</button>
//                   <button type="button" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">Explore articles</button>
//                 </div>
//               </div>
...
//               <div className="space-y-2">
//                 <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Why Pencraft?</h2>
...
//             <div className="flex flex-col items-center justify-center space-y-4 text-center">
//               <div className="space-y-2">
//                 <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Trending on Pencraft</h2>
//                 <p className="max-w-[900px] text-slate-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
...
//                     <div className="rounded-full overflow-hidden h-10 w-10 border bg-slate-100">
//                       {/* <Image
...
//                     Join thousands of writers who have already found their voice on Pencraft. It's free to start.
//                   </p>
//                 </div>
//                 <div className="flex flex-col gap-2 min-[400px]:flex-row">
//                   <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">Create account</button>
...
//             <div className="flex flex-col items-center justify-center space-y-4 text-center">
//               <div className="space-y-2">
//                 <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Meet our top authors</h2>
//                 <p className="max-w-[900px] text-slate-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
...
//                   <div className="rounded-full overflow-hidden h-24 w-24 border-2 border-white shadow-md">
//                     {/* <Image
//                       src={`/placeholder.svg?height=96&width=96&text=A${i}`}
//                       width={96}
//                       height={96}
//                       alt="Author"
//                       className="aspect-square object-cover"
...
//                     <p className="text-sm text-slate-500">Tech Writer</p>
//                   </div>
...
//               </div>
//               <div className="flex items-center justify-center">
//                 <div className="h-[550px] w-[550px] rounded-lg bg-slate-100 flex items-center justify-center text-slate-400">
...
//               <button
//                 type="button"
//                 className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center gap-2"
//               >
//                 See more articles
//                 <ChevronRight className="h-4 w-4" />
//               </button>
...
//               {[1, 2, 3, 4].map((i) => (
//                 <div key={i} className="flex flex-col items-center space-y-4">
//                   <div className="rounded-full overflow-hidden h-24 w-24 border-2 border-white shadow-md flex items-center justify-center bg-slate-100 text-slate-500">
//                     A{i}
//                   </div>
//                   <div className="space-y-1 text-center">
//                     <h3 className="font-bold">Jane Smith</h3>
...
//                 <button
//                   type="button"
//                   className="bg-white text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5"
//                 >
//                   Get started
//                 </button>
//                 <button
//                   type="button"
//                   className="bg-transparent text-white border border-white hover:bg-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-700 font-medium rounded-lg text-sm px-5 py-2.5"
//                 >
//                   Learn more
//                 </button>
//               </div>
