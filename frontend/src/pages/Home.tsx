  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="blogging platform, AI writing assistant, content creation, blog generator, AI summary, write blogs, share stories, online writing community, BlogNest"
        />
        ...
        <meta
          ...
          content="Write, discover, and share stories with AI-powered tools. Join thousands of writers on BlogNest."
        />
        <meta
          property="og:url"
      ...
      `,
          ...
          <section
            className="w-full relative mt-24 sm:mt-20 lg:mt-5 text-center md:text-left"
            id="hero-section"
          >
                  ...
                  >
                    <item.Icon
                      className={`w-8 h-8 mb-3 ${
                        item.className.includes("bg-blue-800")
                          ? "text-white"
                          : "text-black"
                      }`}
                    />
